  ...
  return (
    <div
      className="
        ...
        [&_h4]:text-[13px] [&_h4]:font-medium [&_h4]:text-muted [&_h4]:uppercase [&_h4]:tracking-wider [&_h4]:mt-3 [&_h4]:mb-1
        ...
        [&_code]:text-[13px] [&_code]:bg-surface [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-foreground
        [&_pre]:bg-surface [&_pre]:border [&_pre]:border-border [&_pre]:rounded-md [&_pre]:p-3 [&_pre]:my-3 [&_pre]:overflow-x-auto
        [&_pre>code]:bg-transparent [&_pre>code]:px-0 [&_pre>code]:py-0 [&_pre>code]:text-[13px]
