  ...
  return (
    <div className="h-full flex items-center justify-between px-4 border-b border-border">
      <div className="flex items-center gap-2">
        ...
        <span className="text-base font-medium tracking-tight">Mission Control</span>
      </div>

      <div className="flex items-center gap-2">
        <button
          type="button"
          className="flex items-center gap-2 h-8 px-3 rounded-md bg-surface border border-border text-sm text-muted hover:text-foreground hover:border-surface-2 transition-colors"
        >
          <Search size={13} strokeWidth={1.75} />
          <span>Search</span>
          <kbd className="ml-8 text-[12px] text-muted/70">⌘K</kbd>
        </button>
